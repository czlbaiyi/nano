...
[1]: https://travis-ci.org/czlbaiyi/nano.svg?branch=master
[2]: https://travis-ci.org/czlbaiyi/nano
[3]: https://godoc.org/github.com/czlbaiyi/nano?status.svg
[4]: https://godoc.org/github.com/czlbaiyi/nano
[5]: https://goreportcard.com/badge/github.com/czlbaiyi/nano
[6]: https://goreportcard.com/report/github.com/czlbaiyi/nano
...
- English
    ...
    + [API Reference(Server)](https://godoc.org/github.com/czlbaiyi/nano)
...
- 简体中文
    ...
    + [API参考(服务器)](https://godoc.org/github.com/czlbaiyi/nano)
    + [如何将`lua`脚本集成到`nano`组件中(未完成)](.)

## Resources

- Javascript
  + [nano-websocket-client](https://github.com/czlbaiyi/nano-websocket-client)
  + [nano-egret-client](https://github.com/czlbaiyi/nano-egret-client)

- Demo
  + [Implement a chat room in 100 lines with nano and WebSocket](./examples/demo/chat)
  + [Tadpole demo](./examples/demo/tadpole)
  + [四川麻将, 血战到底(三人模式/四人模式)完整项目实例](https://github.com/czlbaiyi/nanoserver)
...
```shell
go get github.com/czlbaiyi/nano
...
cd $GOPATH/src/github.com/czlbaiyi/nano/benchmark/io
